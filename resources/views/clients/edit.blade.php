            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="custom_id" name="custom_id" value="{{ old('custom_id', $client->custom_id) }}" placeholder="Ej. CLI-001">
                        <small class="text-muted">Opcional, se mostrará junto al nombre.</small>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
